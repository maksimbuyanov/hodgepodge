...
describe("articleDetails.test", () => {
  ...
  test("return undefined", () => {
    ...
    expect(getArticleDetailsError(emptyState as StateSchema)).toBeUndefined()
    expect(getArticleDetailsData(emptyState as StateSchema)).toBeUndefined()
    expect(
      getArticleDetailsIsLoading(emptyState as StateSchema)
    ).toBeUndefined()
  })
})
